...
draft: false
summary: 'This post examines the idea that programming is less about code and more about the internal theory developers construct - a human practice of meaning-making that is not easily captured by AI of today.'
---
